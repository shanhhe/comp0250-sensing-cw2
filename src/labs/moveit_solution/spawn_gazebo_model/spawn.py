...
if __name__ == "__main__":
  ...
  rospy.init_node("labs_object_spawn_node")
  ...
  # delete this
  #rospy.logwarn("SPAWNING NOUGHT")
  #model = Model(model_name="nought_red", instance_name="nought", position=[0.6, 0.2, 0.1])
  #world_spawner.spawn(model)
  #rospy.logwarn("SPAWNING CROSS")
  #model = Model(model_name="cross_red", instance_name="cross", position=[0.6, -0.2, 0.1])
  #world_spawner.spawn(model)
